...
System.out.println(args[0] + args[1]);   //for run this type java Demo1 1 2 
System.out.println(Integer.parseInt(args[0])+Integer.parseInt(args[1])) ;  //Integer.parseInt is a class level static methodss
